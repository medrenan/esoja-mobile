  ...
  const getWaterChartData = (productivity: Produtividade) => {
    ...
    return {
      ...
      datasets: [
        {
          data: balancoHidrico,
          title: 'Hydric balance',
          color: () => `rgb(6, 15, 139)`
        },
        {
          data: deficienciaHidrica,
          title: 'Hydric Deficience',
          color: () => `rgb(171, 193, 5)`
        }
      ],
      legend: ['Hydric balance', 'Hydric Deficience']
    };
  };
    ...
    return {
      ...
      datasets: [
        ...
        },
        {
          ...
          title: 'municipal average',
          color: () => `rgb(6, 15, 139)`
        }
      ],
      legend: ['Productivity', 'municipal average']
    };
  };
  ...
  const handleSubmitCultivar = async (
    ...
    if (idCultivar && idCultivar !== 'default') {
      ...
      Alert.alert(
        ...
        'National Cultivar Registration is mandatory!'
      );
    }
  };
